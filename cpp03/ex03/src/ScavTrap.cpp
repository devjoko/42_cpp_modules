...
/*   Updated: 2022/09/12 17:14:26 by jpfuhl           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap()
: ClapTrap(), _scavHp(100), _scavEn(50), _scavDmg(20)
{
	this->_hitpoints = 100;
	this->_energy = 50;
	this->_damage = 20;
...
: ClapTrap(name), _scavHp(100), _scavEn(50), _scavDmg(20)
{
	this->_hitpoints = 100;
	this->_energy = 50;
	this->_damage = 20;
...
: _scavHp(100), _scavEn(50), _scavDmg(20)
{
